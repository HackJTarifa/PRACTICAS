function createdBoard(files, columns){
        function initializeBoard (files, columns){    
    ...
    let fnBoard = {        
        files: files,
        columns: columns,
        board: initializeBoard(files, columns),
...
function createGame(){
    let game = {
        ...
        printBoard: function (){ // private
            game.board.print();
        },
        playerWin: function(){ //private
            ...
            function checkPosition(column, row, token) { //private
